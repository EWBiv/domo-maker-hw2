...
// Returns one random domo using aggregate and $sample.
DomoSchema.statics.findRandomDomo = (callback) => {
  console.log('Finding random domo3');
  DomoModel.aggregate([{ $sample: { size: 1 } }]).exec(callback);
};
